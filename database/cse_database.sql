...
ALTER TYPE public.account_type OWNER TO cse340projectdatabase;
...
--Table structure for tablet "inventory"
...
--Create relationshi between "classification" and "inventory" tables
